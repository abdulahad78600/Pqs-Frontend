...
import { ArrowRight, ShieldCheck, TrendingUp, Layers, FlaskConical, ExternalLink, Lock, KeyRound } from 'lucide-react'
import SectionHeader from '../components/SectionHeader.jsx'
import AmbientBackdrop from '../components/AmbientBackdrop.jsx'
import { opportunities } from '../data/opportunities.js'
import { getFundBySlug } from '../data/funds.js'
      ...
      <section className="relative py-20 md:py-28">
        ...
        <div className="container-page relative">
          <SectionHeader
            ...
            subtitle="Each opportunity is a Segregated Portfolio (SP) — a ring-fenced strategy whose risk is allocated into one of our fund portfolios: Axis, Aurora, or Orbit."
          />
        </div>
      </section>
      ...
      <section className="container-page pb-20 md:pb-24">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {opportunities.map((o, i) => {
            ...
            const tone = riskTone[fund?.riskProfile] || riskTone.Moderate
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className={`absolute top-4 right-4 px-3 py-1 rounded-full border text-[10px] uppercase tracking-widest font-semibold inline-flex items-center gap-1.5 backdrop-blur-sm shadow-lg shadow-ink-950/40 ${tone.tag}`}>
                    <ToneIcon size={11} /> {fund?.riskProfile} risk
                  </div>
                </div>
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  {/* Risk allocated into a fund portfolio */}
                  <div className="mt-5 pt-5 border-t border-sand-50/8">
                    <div className="text-[10px] uppercase tracking-widest text-sand-50/45">Risk allocated into</div>
                    {fund && (
                      <Link
                        to={`/funds/${fund.slug}`}
                        className="mt-1.5 flex items-center justify-between gap-3 group"
                      >
